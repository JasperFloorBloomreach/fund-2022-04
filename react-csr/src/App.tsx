...
import { FAQList, FAQContent, FAQComments, Banner, Content, Menu, NewsList, DynamicBanner, ContentList, ProductList, ProductContent } from './components';
...
export default function App(props: RouteComponentProps) {
  ...
  const mapping = {'Faq': FAQList,'faq-content' : FAQContent, 'faq-comments' : FAQComments, 'productcontent': ProductContent, 'Product List' : ProductList, 'Content list': ContentList, DynamicBanner, Banner, Content, 'News List': NewsList, 'Simple Content': Content };
